        ...
        <div className="app-layout-header-actions">
          ...
          <div className="app-layout-user-block">
            ...
            <button
              ...
              title={email}
            >
              <span className="app-layout-nav-icon" aria-hidden><SettingsIcon /></span>
            </button>
          </div>
        </div>
      </header>
...
function SettingsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M19.4 15a1.65 1.65 0 01.33 1.82l-.06.11a2 2 0 01-2.18 1.09l-.12-.03a1.65 1.65 0 00-1.51.43l-.09.09a1.65 1.65 0 00-.43 1.51l.03.12a2 2 0 01-1.09 2.18l-.11.06a1.65 1.65 0 01-1.82-.33 1.65 1.65 0 00-2.12 0 1.65 1.65 0 01-1.82.33l-.11-.06a2 2 0 01-1.09-2.18l.03-.12a1.65 1.65 0 00-.43-1.51l-.09-.09a1.65 1.65 0 00-1.51-.43l-.12.03a2 2 0 01-2.18-1.09l-.06-.11A1.65 1.65 0 014.6 15a1.65 1.65 0 000-2 1.65 1.65 0 01-.33-1.82l.06-.11a2 2 0 012.18-1.09l.12.03a1.65 1.65 0 001.51-.43l.09-.09a1.65 1.65 0 00.43-1.51l-.03-.12a2 2 0 011.09-2.18l.11-.06a1.65 1.65 0 011.82.33 1.65 1.65 0 002.12 0 1.65 1.65 0 011.82-.33l.11.06a2 2 0 011.09 2.18l-.03.12a1.65 1.65 0 00.43 1.51l.09.09a1.65 1.65 0 001.51.43l.12-.03a2 2 0 012.18 1.09l.06.11A1.65 1.65 0 0119.4 13a1.65 1.65 0 010 2z" />
    </svg>
  );
}
